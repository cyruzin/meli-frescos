...
func (_m *SectionRepository) GetAll(ctx context.Context) (*[]domain.Section, error) {
	ret := _m.Called(ctx)
...
func (_m *SectionRepository) GetByID(ctx context.Context, id int64) (*domain.Section, error) {
	ret := _m.Called(ctx, id)
...
func (_m *SectionRepository) Store(ctx context.Context, section *domain.Section) (*domain.Section, error) {
...
func (_m *SectionRepository) Update(ctx context.Context, section *domain.Section) (*domain.Section, error) {
	ret := _m.Called(ctx, section)
...
type NewSectionRepositoryT interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewSectionRepository(t NewSectionRepositoryT) *SectionRepository {
